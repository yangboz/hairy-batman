...
.controller('SourceCtrl',function($scope,$log,$ionicLoading,$http,CONFIG_ENV){
      $ionicLoading.show();
      $scope.sourceFiles=[{name:'文件1',id:000},{name:'文件2',id:001}];
      $scope.sourceVideos=[{name:'视频1',id:000},{name:'视频2',id:001}];
      $scope.sourceTargets=[
          {name:'人物1',image:'icon_a_01.png'},
          {name:'人物2',image:'icon_a_02.png'},
          {name:'人物3',image:'icon_a_03.png'},
          {name:'人物4',image:'icon_a_04.png'}
      ];
...
.controller('GroupTabCtrl', function($scope,$log,$ionicLoading,$http,CONFIG_ENV) {
    ...
    {
        $log.info("GroupTabCtrl selected view index:",index);
        $scope.selectedViewIndex = index;
    };
      //@example:http://plnkr.co/edit/lBKFld?p=preview
      /* Chart options */
      $scope.groupAgesChartOptions = {
          chart: {
              type: 'lineChart',
              height: 450,
              margin : {
      ...
      /* Chart data */
      $scope.groupAgesChartData = /*Random Data Generator */
          function sinAndCos() {
              var sin = [],sin2 = [],
                  cos = [];
        ...
        //@example:http://plnkr.co/edit/UASCUL?p=preview
        /* Chart options */
        $scope.groupGendersChartOptions = {
            chart: {
        ...
        //@example:http://plnkr.co/edit/CIGW0o?p=preview
        /* Chart options */
        $scope.groupRacesChartOptions = {
            chart: {
